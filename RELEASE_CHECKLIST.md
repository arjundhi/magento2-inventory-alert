...
- Verify stable install works: `composer require arjundhi/magento2-inventory-alert:^1.0`.
- Verify dev fallback works for pre-tag testing: `composer require arjundhi/magento2-inventory-alert:"dev-main@dev"`.
